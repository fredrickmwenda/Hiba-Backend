            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
                    ...
                    <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                        ...
                        @auth
                        @if(Auth::user()->avatar)
                        <img class="wd-30 ht-30 rounded-circle" src="{{ asset('assets/images/avatar/'. Auth::user()->avatar) }}" alt="profile">
                        @else
                        <img class="wd-30 ht-30 rounded-circle" src="{{ asset('assets/images/avatar/300.jpg') }}" alt="profile">
                        @endif
                        @endauth
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                        @if(Auth::user()->avatar)
                        <img class="wd-80 ht-80 rounded-circle" src="{{ asset('assets/images/avatar/'. Auth::user()->avatar) }}" alt="profile">
                        @else
                        <img class="wd-80 ht-80 rounded-circle" src="{{ asset('assets/images/avatar/300.jpg') }}" alt="profile">
                        @endif
                    ...
                    <li class="dropdown-item py-2">
                       <form action="{{ route('logout') }}" method="POST">
                        @csrf
                            <button type="submit" class="text-body ms-0" style="background: none; border: none; padding: 0; cursor: pointer;">
